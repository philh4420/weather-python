...
def get_weather():
    ...
    weather_data = get_weather_data(place_name)  # Use place_name to fetch weather data
...
def get_weather_data(city):
    ...
    weather_data["WeatherAPI"] = {
        "current": {
            ...
            "condition": weatherapi_current_response["current"]["condition"]["text"],
            ...
            "date_time": datetime.strptime(
                weatherapi_current_response["location"]["localtime"], "%Y-%m-%d %H:%M"
            ).strftime("%d/%m/%Y %H:%M"),
        },
        "forecast": [
            {
